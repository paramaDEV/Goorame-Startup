    ...
    <div class="content">
        ...
        <center>
            <div class="tagihan">
                <?php
                    if($data2==null){
                        echo "<img src='../assets/trolley.png' class='gmbrKeranjang'><br><h2 style='font-family:Roboto,sans-serif'>Anda tidak memiliki belanjaan apapun di keranjang</h2><a href='homeuser.php'><button>Belanja sekarang</button></a>";
                        exit;
                    }else{
                    foreach($data2 as $x):
                ?>
